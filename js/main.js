...
let modal = function(modalClicked) {
    modalView[modalClicked].classList.add('active-modal');
}
...
modalClose.forEach((mc) => {
    mc.addEventListener('click', () => {
        modalView.forEach((mv) => mv.classList.remove('active-modal'));
    })
})

/* ================== MIXITUP FILTER ================== */
const containerEl = document.querySelectorAll('.work__container');
